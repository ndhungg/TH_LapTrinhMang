...
public class frmMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bảng Phân Số");

        btntao.setText("Tạo phân số/ Ghi vào file");
        ...
        jLabel2.setText("số lượng phân số muốn tạo");
    ...
    private void btntaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btntaoActionPerformed
        ...
        for(int i =0;i< Integer.parseInt(txtSoLuong.getText());i++) {
            ...
            oo.close();
            JOptionPane.showMessageDialog(null,"Tạo phân số thành công!"); 
